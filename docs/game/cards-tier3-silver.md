...
| `t3-midas-touch`         | Midas Touch         | —                    | All other players must play a yellow card, otherwise +4 them.                                                          | p.1    |                                                                                         |
...
| `t3-green-tide`          | Green Tide          | `[sP]`, `NEW`        | Double the cards of everyone after 15 rounds.                                                                        | p.2    |                                         |
...
| `t3-investment`          | Investment          | `[P]`, `NEW`         | At the start of your turn, you may choose to draw 1 additional card.                                                           | p.2    |                                                                                         |
...
| `t3-liquidation`         | Liquidation         | `NEW`                | You can't draw in the deck for 2 rounds. You are skipped instead.                                                | p.2    |                                                                                         |
| `t3-all-in`              | All In              | `NEW`                | Get 2 Diamond Vaults. After 3 rounds, +20 and discard all your Vaults.                                               | p.2→3  | Effect text continues from p.2 onto p.3.                                                |
