...
- **Tags**: `[P]` passive, `[sP]` special passive, `[Tentative]`, `NEW` (see `../STYLE.md`).
...
| -------------------------- | ---------------------------------- | ------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- | -------- | ----------- | -------- | --------------------------------------------- | ------ | ------------------------------------------------ |
| `t3-hush`                  | Hush I                             | Silver  | —               | Skip 2 players for 1 round.                                                                                                                                                                                                                            | draft     | Yes      | Yes         | —        | —                                             | p.1    | skip = 1 skipped turn                            |
| `t3-mitosis`               | Mitosis I                          | Silver  | —               | +1 to 2 players.                                                                                                                                                                                                                                       | draft     | Yes      | Yes         | —        | —                                             | p.1    | random targets                                   |
| `t3-scrap-shot`            | Scrap Shot I                       | Silver  | —               | Pick a player, +1 them and discard 1 card without seeing their cards.                                                                                                                                                                                  | stable    | Yes      | Yes         | —        | —                                             | p.1    | blind discard                                    |
| `t3-trade-sector`          | Trade Sector I                     | Silver  | —               | Switch 2 cards in your hand with any player without seeing their cards. If they have less than 2 cards, +1 them.                                                                                                                                       | draft     | Yes      | Yes         | —        | —                                             | p.1    | blind swap; fallback +1                          |
| `t3-disorder`              | Disorder                           | Silver  | —               | Rearrange the order of players.                                                                                                                                                                                                                        | draft     | No       | No          | —        | —                                             | p.1    |                                                  |
| `t3-imploded-clockwork`    | Imploded Clockwork                 | Silver  | —               | Return played cards by 3 turns.                                                                                                                                                                                                                        | draft     | Yes      | Yes         | —        | —                                             | p.1    | undoes last 3 plays via pile history             |
| `t3-prototype-z`           | Prototype Z                        | Silver  | —               | Throw a coin, if it's heads skip yourself, otherwise +4 anyone.                                                                                                                                                                                        | draft     | Yes      | Yes         | —        | —                                             | p.1    | coin flip via rng                                |
| `t3-midas-touch`           | Midas Touch                        | Silver  | —               | All players must play a yellow card, otherwise +4 them.                                                                                                                                                                                                | draft     | Yes      | Yes         | —        | —                                             | p.1    | auto-resolved color challenge                    |
...
| `t3-future-market`         | Future Market                      | Silver  | —               | Give 2 cards to any player and return the cards in 4 rounds.                                                                                                                                                                                           | draft     | Yes      | Yes         | —        | 6+ cards                                      | p.1    | `hold` cost gate; deferred return                |
| `t3-blitzkrieg`            | Blitzkrieg                         | Silver  | —               | For 5 seconds you can draw as many cards as possible. [1 by 1 only].                                                                                                                                                                                   | draft     | No       | No          | —        | —                                             | p.1    |                                                  |
| `t3-accumulation`          | Accumulation                       | Silver  | [sP]            | Your next + card is x2.                                                                                                                                                                                                                                | draft     | Yes      | Yes         | —        | —                                             | p.1    | one-shot: doubles the owner's next +2/+4         |
| `t3-scavenge`              | Scavenge                           | Silver  | —               | Discard 1-5 cards in your hand. Draw 1 for each card discarded.                                                                                                                                                                                        | draft     | Yes      | Yes         | —        | —                                             | p.1    |                                                  |
| `t3-upgrade`               | Upgrade!                           | Silver  | [sP] NEW        | Your next vault will be 1 tier higher. (Diamond Max).                                                                                                                                                                                                  | draft     | No       | No          | —        | —                                             | p.2    |                                                  |
| `t3-green-tide`            | Green Tide                         | Silver  | [sP] NEW        | Double the cards of everyone after 15 rounds divided by 1.5.                                                                                                                                                                                           | draft     | Yes      | Yes         | —        | —                                             | p.2    | deferred; draw ⅓ of hand at round 15             |
| `t3-double-edged-sword`    | Double Edged Sword                 | Silver  | NEW             | +4 a player and +1 yourself.                                                                                                                                                                                                                           | draft     | Yes      | Yes         | —        | —                                             | p.2    | random enemy                                     |
| `t3-offerings`             | Offerings                          | Silver  | NEW             | Get a Silver Vault and +2 anyone.                                                                                                                                                                                                                      | draft     | Yes      | Yes         | —        | discard 3 draw [+] cards                      | p.2    | play-condition: discard before resolving         |
| `t3-investment`            | Investment                         | Silver  | [P] NEW         | Each round, you may choose to draw an additional card.                                                                                                                                                                                                 | draft     | Yes      | Yes         | —        | —                                             | p.2    | auto-draws +1 for the owner each round           |
| `t3-flash-flood`           | Flash Flood                        | Silver  | NEW             | All other players must play a blue card, otherwise +4 them.                                                                                                                                                                                            | draft     | Yes      | Yes         | —        | —                                             | p.2    | auto-resolved color challenge                    |
| `t3-red-flag`              | Red Flag                           | Silver  | NEW             | All other players must play a red card, otherwise +4 them.                                                                                                                                                                                             | draft     | Yes      | Yes         | —        | —                                             | p.2    | auto-resolved color challenge                    |
| `t3-green-thumb`           | Green Thumb                        | Silver  | NEW             | All other players must play a green card, otherwise +4 them.                                                                                                                                                                                           | draft     | Yes      | Yes         | —        | —                                             | p.2    | auto-resolved color challenge                    |
...
| `t3-liquidation`           | Liquidation                        | Silver  | [Tentative] NEW | You can't draw in the deck for 2 rounds. You are skipped instead.                                                                                                                                                                                      | tentative | Yes      | Yes         | —        | —                                             | p.2    | round-scoped self-skip                           |
| `t3-all-in`                | All In                             | Silver  | [Tentative] NEW | Get 2 Diamond Vaults. After 3 rounds, +15 and discard your Vaults.                                                                                                                                                                                     | tentative | Yes      | Yes         | —        | —                                             | p.2-3  | deferred payout + vault discard                  |
| `t2-hush`                  | Hush II                            | Gold    | —               | Skip 2 random players for 3 turns.                                                                                                                                                                                                                     | draft     | Yes      | Yes         | —        | —                                             | p.3    | skip = 3 skipped turns                           |
| `t2-mitosis`               | Mitosis II                         | Gold    | —               | +2 to 2 players.                                                                                                                                                                                                                                       | draft     | Yes      | Yes         | —        | —                                             | p.3    | random targets                                   |
| `t2-scrap-shot`            | Scrap Shot II                      | Gold    | —               | Pick a player, +3 them and discard 3 cards without seeing their cards.                                                                                                                                                                                 | stable    | Yes      | Yes         | —        | —                                             | p.3    | blind discard                                    |
| `t2-force-of-will`         | Force of Will                      | Gold    | —               | Pick a player to play any + card, if they don't +5 them.                                                                                                                                                                                               | draft     | Yes      | Yes         | —        | —                                             | p.3    | auto-resolved; target plays a + card or draws 5  |
| `t2-trade-sector`          | Trade Sector II                    | Gold    | —               | Switch 3 cards in your hand with anyone without seeing their cards. If they have less than 3 cards, +2 them.                                                                                                                                           | draft     | Yes      | Yes         | —        | —                                             | p.3    | blind swap; fallback +2                          |
| `t2-future-sight`          | Future Sight                       | Gold    | —               | See the cards of a player.                                                                                                                                                                                                                             | draft     | Yes      | Yes         | —        | —                                             | p.3    | reveals one hand to the actor                    |
| `t2-jettison`              | Jettison                           | Gold    | —               | Pick a color, discard all of those cards with the same color.                                                                                                                                                                                          | draft     | Yes      | Yes         | —        | color pick                                    | p.3    | actor's own hand; vault color prompt             |
| `t2-augmented-zep-y`       | Augmented Zep-y                    | Gold    | —               | Throw a coin, if it's heads skip yourself for 2 turns, otherwise +6 anyone.                                                                                                                                                                            | draft     | Yes      | Yes         | —        | —                                             | p.3    | coin flip via rng                                |
| `t2-card-a-palooza`        | Card-a-Palooza                     | Gold    | —               | All players shuffle their cards with each other and return with the same amount of cards.                                                                                                                                                              | stable    | Yes      | Yes         | —        | —                                             | p.3    |                                                  |
...
| `t2-most-wanted`           | Most Wanted                        | Gold    | [P]             | Pick a player, that player will be +1 every time they play a blue or red card.                                                                                                                                                                         | draft     | Yes      | Yes         | —        | —                                             | p.3    | target +1 on each blue/red play                  |
| `t2-ruin`                  | Ruin                               | Gold    | NEW             | Get a Gold Vault and +3 2 enemy players.                                                                                                                                                                                                               | draft     | Yes      | Yes         | —        | discard 7 red or yellow cards                 | p.3-4  | play-condition: discard before resolving         |
...
| `t2-cruelty`               | Cruelty                            | Gold    | [sP]            | Pick 2 players, neither of them can win until both of their hands are reduced to 1.                                                                                                                                                                    | draft     | Yes      | Yes         | —        | —                                             | p.4    | blocks wins; lifts when both victims at 1 card   |
| `t2-parasitism`            | Parasitism                         | Gold    | [P]             | Pick a player, whenever they play a green card, discard a card from your hand. Discard your cards starting in 9-0, switch color, skip, reverse, +2, +4, and Tier III-I.                                                                                | draft     | Yes      | Yes         | —        | —                                             | p.4    | owner discards 9→0, specials, then vaults        |
| `t2-vault-hunter`          | Vault Hunter                       | Gold    | —               | Pick 1-3 players and steal up to 2 vault cards from them.                                                                                                                                                                                              | stable    | Yes      | Yes         | —        | —                                             | p.4    |                                                  |
| `t2-rummage`               | Rummage                            | Gold    | —               | Discard your hand. Draw 1 for each card discarded. It's your turn again.                                                                                                                                                                               | draft     | Yes      | Yes         | —        | —                                             | p.4    | keepTurn                                         |
...
| `t2-twice-than-one`        | Twice than One!                    | Gold    | [Tentative]     | Get 2 Silver Vaults.                                                                                                                                                                                                                                   | tentative | Yes      | Yes         | —        | —                                             | p.4    |                                                  |
| `t2-sacrificial-lamb`      | Sacrificial Lamb                   | Gold    | [Tentative]     | Discard 2 special cards to draw 10.                                                                                                                                                                                                                    | tentative | Yes      | Yes         | —        | discard 2 special cards                       | p.4    | play-condition: discard before resolving         |
| `t2-flight-of-icarus`      | Flight of Icarus                   | Gold    | [Tentative]     | (effect unreadable in PDF).                                                                                                                                                                                                                            | tentative | No       | No          | —        | —                                             | p.4    |                                                  |
| `t1-global-silence`        | Global Silence                     | Diamond | —               | Skip all enemy players for 3 rounds.                                                                                                                                                                                                                   | draft     | Yes      | Yes         | —        | —                                             | p.4    | skip = 3 skipped turns                           |
| `t1-meiosis`               | Meiosis                            | Diamond | —               | +3 to all enemy players.                                                                                                                                                                                                                               | draft     | Yes      | Yes         | —        | —                                             | p.4    |                                                  |
| `t1-scrapheap`             | Scrapheap                          | Diamond | —               | +1 to all enemy players and discard a total of 1-7 cards to any enemy players while seeing their cards.                                                                                                                                                | draft     | Yes      | Yes         | —        | —                                             | p.4    | pick-cards discard mode                          |
| `t1-plunder`               | Plunder                            | Diamond | —               | Pick an enemy player, +3 them and steal 1-3 cards while seeing their cards.                                                                                                                                                                            | draft     | Yes      | Yes         | —        | —                                             | p.5    | pick-cards steal mode                            |
| `t1-suicide`               | Suicide                            | Diamond | —               | +12 to yourself and to any enemy player.                                                                                                                                                                                                               | draft     | Yes      | Yes         | —        | —                                             | p.5    | random enemy                                     |
| `t1-all-seeing-eye`        | All Seeing Eye                     | Diamond | [P]             | See the cards of everyone and pick one to see their cards forever.                                                                                                                                                                                     | draft     | Yes      | Yes         | —        | —                                             | p.5    | one-shot all + permanent reveal pick             |
| `t1-jack-of-all-trades`    | Jack of All Trades                 | Diamond | —               | +1 a random enemy player, skip a random enemy player for 1 round, discard 1 card from any enemy player while seeing their cards and see all the cards of a random enemy player.                                                                        | draft     | Yes      | Yes         | —        | —                                             | p.5    | random buff/skip/reveal + 1 pick                 |
| `t1-g-switch`              | G-Switch                           | Diamond | —               | Switch hands with anyone.                                                                                                                                                                                                                              | stable    | Yes      | Yes         | —        | —                                             | p.5    |                                                  |
...
| `t1-zephyr`                | Zephyr                             | Diamond | [P]             | You can play 2 cards in your turn, some special cards have effects and +2 to all enemy players.                                                                                                                                                        | draft     | Yes      | Yes         | —        | Prototype Z and Augmented Zep-y played by you | p.5    | keepTurn 2×/turn; any special +2 to all enemies  |
| `t1-tyranny`               | Tyranny                            | Diamond | [P]             | Whenever you skip an enemy player +3 them. Skip the next player.                                                                                                                                                                                       | draft     | Yes      | Yes         | —        | —                                             | p.5    | skips next seat at activation; +3 per skip       |
| `t1-equality`              | Equality                           | Diamond | [P]             | Everytime you play an even no. card, +2 to a random enemy player.                                                                                                                                                                                      | draft     | Yes      | Yes         | —        | —                                             | p.5    | random enemy +2 per even number play             |
...
| `t1-maim`                  | Maim                               | Diamond | [P]             | All enemies with more than 2 cards gain Bleed, every 2 cards added after that, gain another Bleed. When enemies have 5 stacks of Bleed, +20 them and reset the Bleed.                                                                                  | draft     | Yes      | Yes         | —        | —                                             | p.6    | recomputed from hand size; never decays          |
| `t1-cutthroat`             | Cutthroat                          | Diamond | [sP]            | All enemy players cannot use special cards anymore. Their special cards are now Deadweight. Remove all Deadweight once everyone's total cards is 30. If they aren't removed in 20 rounds, +4 them for each Deadweight they are holding and discard it. | draft     | Yes      | Yes         | —        | —                                             | p.6    | specials unplayable; ends at 30 total or +20 rds |
| `t1-silver-tongue`         | Silver Tongue                      | Diamond | [P]             | No one can play their last card if you're still in the game. Switch everyone's hand clockwise every round. Everyone can see EVERYONE'S cards.                                                                                                          | draft     | Yes      | Yes         | —        | —                                             | p.6    | blocks non-owner wins; clockwise pass per round  |
...
| `t1-scourge`               | Scourge                            | Diamond | [P]             | Pick a player to infect, after that player reaches 1 card, +1 to them and +2 to all other enemies. Infect the next player after them until it reaches the host again. You can't get infected.                                                          | draft     | Yes      | Yes         | —        | —                                             | p.6    | spreads to next non-host; ends back at host      |
| `t1-prayers`               | Prayers                            | Diamond | [P]             | All your red cards have +1. Gain additional + if you played the following before prayers; Offerings, +1. Path to Ruin, +2. Both, +4.                                                                                                                   | draft     | Yes      | Yes         | —        | —                                             | p.6-7  | +1 (+bonus) to next seat per red play            |
...
| `t1-ultimate-machine-form` | Ultimate Machine Form              | Diamond | [Tentative]     | All your moves are now doubled.                                                                                                                                                                                                                        | tentative | Yes      | Yes         | —        | —                                             | p.7    | doubles owner's + cards and vault amounts        |
| `t1-thrice-than-twice`     | Thrice Than Twice!                 | Diamond | [Tentative]     | Get 3 Silver Vaults.                                                                                                                                                                                                                                   | tentative | Yes      | Yes         | —        | —                                             | p.7    |                                                  |
...
| `t1-sloth`                 | Sloth                              | Diamond | —               | Skip all enemies for 20 rounds.                                                                                                                                                                                                                        | draft     | Yes      | Yes         | —        | —                                             | p.7    | skip = 20 skipped turns                          |
| `t1-genesis`               | Genesis                            | Diamond | —               | +6 to all enemy players. The enemy with the most cards is skipped depending on the no. of cards that they have.                                                                                                                                        | draft     | Yes      | Yes         | —        | —                                             | p.7    | skips most-cards enemy 1 turn                    |
| `t1-scrapstorm`            | Scrapstorm                         | Diamond | —               | Pick a total of 1-15 cards to any enemy players while seeing their cards, then give them to other players.                                                                                                                                             | draft     | Yes      | Yes         | —        | —                                             | p.7    | pick-cards give mode (random others)             |
| `t1-avarice`               | Avarice                            | Diamond | —               | +2 to all players then steal a total of 1-5 cards to any enemy players while seeing their cards.                                                                                                                                                       | draft     | Yes      | Yes         | —        | —                                             | p.7    | +2 all then pick-cards steal                     |
| `t1-damnation`             | Damnation                          | Diamond | —               | +1 to yourself and +23 to an enemy player.                                                                                                                                                                                                             | draft     | Yes      | Yes         | —        | —                                             | p.7    | random enemy                                     |
| `t1-omniscient`            | Omniscient                         | Diamond | [P]             | See all the cards permanently and skip anyone for 5 rounds.                                                                                                                                                                                            | draft     | Yes      | Yes         | —        | —                                             | p.7    | permanent all + skip 5                           |
| `t1-jack-master`           | Jack of all Trades, Master of Some | Diamond | —               | +4 2 enemy players, skip 2 enemy players for 4 rounds, discard 1-4 cards from 2 enemy players while seeing their cards and see all the cards of 2 enemy players.                                                                                       | draft     | Yes      | Yes         | —        | —                                             | p.7    | pick 1-4 per player (2 players)                  |
| `t1-envy`                  | Envy                               | Diamond | —               | Switch hands with anyone and do it again to another pair of players.                                                                                                                                                                                   | draft     | Yes      | Yes         | —        | —                                             | p.7    | needs 4+ players for second swap                 |
...
1. A player plays a vault token → the server samples **up to 5 random same-tier catalog cards
   that have a registered resolver** as offers (`sampleVaultOffers`). Fewer than 5 implemented
