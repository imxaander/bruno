      ...
      >
        ...
        {!profile || !rank ? (
          ...
          >
            ...
            >
              {error
                ? `Your profile couldn't be loaded from Firebase: ${error}`
                : "Profile not available yet — sign in while connected to load your profile and rank."}
            </div>
            <button
              onClick={onClose}
              style={{
          ...
          <div style={{ padding: "20px", display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            {/* Email */}
            {email ? (
              <div style={{ fontSize: 12, color: "rgba(200,216,240,0.4)" }}>{email}</div>
            ) : null}
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
                  ...
                  <button
                    ...
                    style={{
                      background:
                        saving || !username.trim() ? "rgba(0,238,255,0.1)" : "rgba(0,238,255,0.2)",
