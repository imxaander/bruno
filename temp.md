...
[sP] Semi Passive: A conditional card. Triggers automatically when its condition is met.
Special Cards: Includes all Action cards and all Vault cards.
...
🔷 Disorder
Rearrange the order of players.

🔷 Imploded Clockwork
Revert played cards by 3 turns.

🦿 Prototype Z (Requirement I)
Throw a coin, if it's heads skip yourself, otherwise +4 anyone.

🔷 Midas Touch
All other players must play a yellow card, otherwise +4 them.

🔷 Flash Flood
All other players must play a blue card, otherwise +4 them.

🔷 Red Flag
All other players must play a red card, otherwise +4 them.
...
🔶 Cruelty [sP]
Target 2 players, neither of them can win until both of their hands are reduced to 1.
...
-Omega Vaults will be added into the deck after 3 Diamond Vaults have been played-
...
Deadweight: cannot be played, discarded or traded.
REQUIREMENT: You must play Boot and Leg.
